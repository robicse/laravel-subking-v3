            ...
            <div class="col-md-3" id="sidebar">
                <div class="theiaStickySidebar">
                    <div id="cart_box">
                        ...
                        <hr>
                        <a class="btn_full" href="{{route('menu')}}">Go to checkout</a>
                        <a class="btn_full_outline" href="{{route('cart-two')}}"><i class="icon-right"></i> Add other items</a>
                    </div><!-- End cart_box -->
