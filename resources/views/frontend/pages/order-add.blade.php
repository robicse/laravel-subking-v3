                                            ...
                                            <div class="row">
                                                ...
                                                @foreach($ingredient as $ingr)
                                                    <label style="margin-left: 30px">
                                                        ...
                                                        <br/>
                                                        <div style="text-align: center;margin-top: 5px;">{{$ingr->name ? $ingr->name : ''}}</div>
                                                        <div style="text-align: center;margin-top: 5px;">Price: ${{$ingr->price ? $ingr->price : 0}}</div>
                                                    </label>
                                                @endforeach
                                            </div>
                                        </div>
                                            ...
                                            <div class="row">
                                                ...
                                                @foreach($ingredient as $ingr)
                                                    ...
                                                    <label style="margin-left: 30px">
                                                        ...
                                                        <img src="{{asset('uploads/ingredient/'.$ingr->image)}}" class="img-fluid" style="width: 200px;margin-right: 10px" >
                                                        <br/>
                                                        <div style="text-align: center;margin-top: 5px;font-size: 14px">{{$ingr->name ? $ingr->name : ''}}</div>
                                                        <div style="text-align: center;margin-top: 5px;font-size: 14px">Price: ${{$ingr->price ? $ingr->price : 0}}</div>
                                                    </label>
                                                @endforeach
                                            </div>
                                        </div>
        ...
        $(document).ready(function () {
            $('input[type="checkbox"]').click(function(){
                ...
                if($(this).prop("checked") == true){
                    ...
                    $('.ul-list-ingredient').append('<li id="li_'+this.id+'" data-id="bind_'+price[1]+'"style="margin-right: 5px;cursor:pointer;" class="li-list-ingredient test"><span>'+this.value+'</span> <i class="icon-cancel" style="color: black!important;"></i></li>')
...
//     alert($(this).text());
// });
//             $(".li-list-ingredient").on("click",function () {
//
//                 var str = this.id;
//                 var chk = str.split("_");
//                 console.log(chk);
...
//             });
            ...
            // $(".ul-list-ingredient").on("click","test",function () {
            //
            //     var str = this.id;
            //     var chk = str.split("_");
            //     console.log(chk);
