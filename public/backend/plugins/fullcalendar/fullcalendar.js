...
var DragListener = Class.extend({
	...
	// Call this when the Users does a mousedown. Will probably lead to startListening
	...
	// Called when the Users moves the mouse
	...
	// Called when the Users does a mouseup
	mouseup: function(ev) {
		this.stopDrag(ev);
	...
	// Call this to stop listening to the Users's mouse events
...
var MouseFollower = Class.extend({
	...
	// Gets called when the Users moves the mouse
	mousemove: function(ev) {
...
Grid.mixin({
	...
	mousedOverSeg: null, // the segment object the Users's mouse is over. null if over nothing
	...
	destroyEvents: function() {
		this.triggerSegMouseout(); // trigger an eventMouseout if Users's mouse is over an event
	...
	// Called when the Users does a mousedown on an event, which might lead to dragging.
...
DayGrid.mixin({
	...
	showSegPopover: function(cell, moreLink, segs) {
		...
		options = {
			...
			autoHide: true, // when the Users clicks elsewhere, hide the popover
...
var View = fc.View = Class.extend({
	...
	isSelected: false, // boolean whether a range of time is Users-selected or not
	...
	// Computes the new date when the Users hits the prev button, given the current date
	...
	// Computes the new date when the Users hits the next button, given the current date
	...
	// Sets the scroll value of the scroller to the initial pre-configured state prior to allowing the Users to change it
	...
	// Computes if the given event is allowed to be dragged by the Users
	...
	// Computes if the given event is allowed to be resize by the Users
	...
	// Handler for unselecting when the Users clicks something and the 'unselectAuto' setting is on
	documentMousedown: function(ev) {
		var ignore;

		// is there a selection, and has the Users made a proper left click?
	...
	function refetchEvents() { // can be called as an API method
		destroyEvents(); // so that events are cleared before Users starts waiting for AJAX
